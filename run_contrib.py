# -*- coding: utf-8 -*-
"""Orquestra a etapa de CONTRIBUICAO (Ideias 1 e 2). Pressupoe que a reproducao ja
foi executada (run_all.py), pois reaproveita os dados coletados e o MM grid. Cada
passo guarda suas saidas, entao rodar de novo e barato. Ver CONTRIBUICAO.md."""
